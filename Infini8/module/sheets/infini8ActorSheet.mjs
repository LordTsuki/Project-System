 ...
 * @extends {Actor}
 */
export default class Infini8ActorSheet extends ActorSheet {
    get template() {
        return `systems/Infini8/templates/sheets/${this.actor.type}-sheet.html`;
    }
  /**
  ...
  static async create(data, options) {
    LOGGER.trace("create | Infini8CharacterActor | called.");
    const createData = data;
    if (typeof data.system === "undefined") {
      LOGGER.trace("create | New Actor | Infini8CharacterActor | called.");
      createData.token = {
        actorLink: true,
        disposition: 1,
        vision: true,
